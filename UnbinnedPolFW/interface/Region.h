#ifndef PHYSUTILS_UNBINNEDPOLFW_REGION_H__
#define PHYSUTILS_UNBINNEDPOLFW_REGION_H__
...
public:
  ...
  template<Boundary BB>
  friend std::ostream& operator<<(std::ostream& os, const Region<BB>& region);
private:
  double m_min{};
  double m_max{};
  std::string m_name{};
